...
interface ExpenseItemProps {
  ...
  currency: string;
  onClick: () => void;
  // Optional to avoid breaking parent usage immediately, but unused
  onDelete?: () => void;
}
...
const ExpenseItem: React.FC<ExpenseItemProps> = ({
  ...
  return (
    <div
      onClick={onClick}
      className="py-6 border-b border-black cursor-pointer hover:brightness-110 transition-all bg-[#1F1A17]"
    >
